                ...
                <table border="1" cellpadding="10" cellspacing="0" class="min-w-full bg-white shadow-md rounded-lg">
                    ...
                    ?>
                        <tr class="border-b">
                            ...
                            <td class="py-3 px-4"><?= $jadwalPenerbangan["tanggal_go"]; ?></td>
                            <td class="py-3 px-4"><?= $jadwalPenerbangan["waktu_go"]; ?> - <?= $jadwalPenerbangan["waktu_land"]; ?></td>
                            ...
                            <td class="py-3 px-4 text-center">
                                <a href="hapus.php?id=<?= $id_jadwal ?>" class="text-red-500 hover:underline">Delete</a>
                            </td>
                        </tr>
                        <?php $no++; ?>
                    <?php endforeach; ?>
